// ignore_for_file: deprecated_member_use, unnecessary_type_check
...
class _CameraPageState extends State<CameraPage> {
    ...
    var input = List.generate(1, (i) => 
      List.generate(224, (y) => 
        List.generate(224, (x) {
          ...
          if (pixel is int) { // v3
             r = img.getRed(pixel).toDouble();
             g = img.getGreen(pixel).toDouble();
             b = img.getBlue(pixel).toDouble();
          } else { // v4
             dynamic p = pixel;
             r = p.r.toDouble();
             g = p.g.toDouble();
  ...
  Future<void> _saveToHistory(Map<String, dynamic> result) async {
    ...
    final List<String> history = prefs.getStringList('banana_history') ?? [];
